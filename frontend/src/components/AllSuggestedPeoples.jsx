...
const Followers = ({ allSuggestions, setAllSuggestions }) => {
  return (
    <>
      <div className="bg-black/50  w-full fixed top-0 z-100">
        <div
          className={`${
            allSuggestions ? "" : "hidden"
          } container w-[50%] mx-auto shadow-lg rounded-md mt-9 p-3 z-100 bg-white`}
        >
